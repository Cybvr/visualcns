...
export default function AgencyBillingPage() {
  ...
  useEffect(() => { if (!authLoading && isAdmin) void getTenant().then(setTenant) }, [authLoading, isAdmin])
