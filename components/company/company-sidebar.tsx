 ...
 * and quick actions. Read-only whenever `admin` is omitted.
 */
...
/**
 * The editable Details fields (including tags), shown on the Overview tab.
...
export function CompanyDetails({
  ...
  return (
    <div>
      ...
      {onSave ? (
          <div className="mt-4 divide-y divide-border/60 rounded-2xl border border-border/60 bg-card px-4">
