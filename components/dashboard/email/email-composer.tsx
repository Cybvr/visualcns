...
import { Check, ChevronDown, ChevronsUpDown, Clock, Eye, FileText, Loader2, Send, Trash2, X } from "lucide-react"
  ...
  return (
    <>
      <div className="fixed inset-x-0 bottom-0 z-40 flex justify-center sm:inset-x-auto sm:right-6 sm:justify-end">
        <div className={cn("flex w-full flex-col overflow-hidden border border-border bg-card shadow-2xl sm:w-[512px] sm:max-w-[calc(100vw-3rem)] sm:rounded-t-xl", composeMinimized ? "h-auto" : "h-[100svh] sm:h-[560px] sm:max-h-[calc(100svh-2rem)]")}>
