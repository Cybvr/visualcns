...
export function EmailTemplates({
  ...
  return (
    <section className="flex min-h-0 w-full min-w-0 max-w-full flex-1 flex-col gap-4 lg:gap-6 lg:overflow-hidden" role="tabpanel">
      ...
      <div className={cn("min-h-0 w-full min-w-0 max-w-full rounded-lg border border-border bg-card lg:flex-1 lg:overflow-y-auto", mobileTemplateView === "list" ? "block" : "hidden")}>
